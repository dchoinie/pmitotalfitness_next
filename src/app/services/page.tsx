            ...
            <Card>
              <CardHeader className="border-b">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-primary/10 text-primary border-primary/20 font-heading uppercase tracking-wide text-xs">
                    Members
                  </Badge>
                </div>
              </CardHeader>
      ...
      <section className="py-16 bg-zinc-900 text-white">
        <div className="mx-auto max-w-6xl px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Button
              asChild
              className="font-heading uppercase tracking-wide px-8"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="font-heading uppercase tracking-wide px-8 border-zinc-600 text-zinc-900 hover:bg-zinc-800"
            >
